  ...
  return (
    <div className="">
      <header className="flex flex-col px-5 py-4 border-b border-gray-100">
        <div className='flex items-center space-x-2 cursor-pointer hover:opacity-40' onClick={onBack}>
    ...
    <>
      ...
      `}>
        {schedules && schedules.map((schedule, index) => (
          <div key={schedule.id} className='col-span-12 md:col-span-6 xl:col-span-4'>
            <div className={`
            ...
            `}>
              ...
              <div className={`flex items-center space-x-2 text-sm text-gray-600`}>
                <div className="flex items-center space-x-2">
                  ...
                  <span>
                    {schedule.paket.soal_count} soal
                  </span>
                </div>
                <div className="flex items-center space-x-2">
                  <svg className="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 3v4M3 5h4M6 17v4m-2-2h4m5-16l2.286 6.857L21 12l-5.714 2.143L13 21l-2.286-6.857L5 12l5.714-2.143L13 3z" /></svg>
                  <span>
                    {schedule.paket.kkm} KKM
                  </span>
                </div>
              </div>
